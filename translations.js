const translations = {
    // --- NUEVOS TEXTOS DE UI (ESTO FALTABA) ---
    intro_title: { 
        es: "INPUT_REQUESTED", 
        en: "INPUT_REQUESTED", 
        de: "INPUT_REQUESTED" 
    ...
    // --- PREGUNTAS (Añadidas traducciones básicas para que no falle) ---
    
    // BLOQUE 1
    q1_title: {
        es: "1. ¿En qué punto te encuentras en tu entrenamiento?",
        en: "1. What is your current training status?",
        de: "1. Wie ist dein aktueller Trainingsstand?"
    },
    ...
    q2_title: {
        ...
        de: "2. Welches Tool nutzt du hauptsächlich?"
    },
    ...
    q3_title: {
        ...
        de: "3. In welcher Kategorie nutzt du Apps am meisten?"
    },
